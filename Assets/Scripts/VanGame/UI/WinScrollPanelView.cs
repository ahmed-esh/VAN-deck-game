...
{
  /// <summary>
  /// Scrollable win screen: auto-scrolls through tall content, shows final stats, restart at the bottom.
  /// Mirror of LoseScrollPanelView for the duplicated win panel hierarchy.
  /// </summary>
  public class WinScrollPanelView : MonoBehaviour
  {
    [Header("Scroll")]
